        ...
        <header className="z-50 font-display sticky top-0 bg-white">
            <div className="container mx-auto flex justify-between">
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon url="https://linkedin.com/in/hans-aasland" className="mr-4" target="_blank" fgColor="#fff" bgColor="#685044" style={{ height: 35, width: 35}}/>
                    <SocialIcon url="mailto:aaslandhans@gmail.com" className="mr-4" target="_blank" fgColor="#fff" bgColor="#685044" style={{ height: 35, width: 35}}/>
