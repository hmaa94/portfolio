...
export default function VySmidig() {
    return  (
        <div className="">
            <div className="ml-8 md:ml-0 relative flex justify-center">
                <div className="mx-auto lg:pr-80 lg:mt-60">
                    <h1 className="font-body font-medium text-lg">dør-til-dør-løsning for VY</h1>
                    <p className=" text-4xl md:text-4xl lg:text-5xl mb-20 md:mb-2 lg:mb-8 font-bold font-body">Eksamen i smidig utvikling</p>
                </div>
            </div>
    
    <div className="mx-auto flex relative justify-center"><img src={image1} alt="Vy smidig prosjekt" className=" md:my-24 lg:my-40 rounded shadow object-cover h-96 lg:w-2/4"/></div>
        <div>
        <p className="mt-8 mb-8 lg:mt-20 font-bold lg:text-2xl relative flex justify-center mx-5 lg:mx-auto md:px-8 lg:px-36 lg:w-7/12">
            Hvordan legger vi til rette for en bedre dør-til-dør-opplevelse for VYs kunder?
            </p>
        <p className="lg:leading-8 font-montserrat text-black mb-8 text-base lg:text-xl relative flex justify-center mx-5 lg:mx-auto md:px-8 lg:px-36 text-lg lg:w-7/12">
            Som en del av bachelorgraden gjennomførte vi et smidig utviklingsprosjekt gjennom 2.året. 
            Jeg valgte VY som oppdragsgiver, hvor oppgaven var å lage den ultimate dør-til-dør-løsningen. Prosjektet gikk over åtte uker, hvor vi jobbet i et tverrfaglig team på åtte studenter fra ulike IT-linjer og Digital Markedsføring.
            </p>
    <h2 className="font-body text-black my-8 lg:my-40 font-bold text-3xl lg:text-4xl relative flex justify-center">Prosjektdetaljer
      ...
      <div className="relative flex justify-center grid grid-cols-3 mb-10 mx-auto w-11/12 lg:w-7/12">
          ...
          <div>
    <h2 className="font-body text-black mt-8 lg:mt-24 mb-8 lg:mb-20 font-bold text-5xl relative flex justify-center">prosess</h2>
        ...
        <h2 className="font-body text-black mb-5 font-bold text-2xl lg:text-2xl relative flex justify-center subpixel-antialiased">Metoder og teknikker</h2>
        <div  className=" lg:leading-8 font-montserrat text-black mb-8 text-base lg:text-xl relative flex justify-center mx-5 lg:mx-auto md:px-8 lg:px-36 text-lg lg:w-7/12">
        ...
        <div className="relative flex justify-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto mb-10 lg:w-7/12">
        ...
        <h2 className="font-body text-black mb-5 font-bold text-2xl lg:text-2xl relative flex justify-center subpixel-antialiased">Brukertesting</h2>
            ...
            ble informert i forkant om at de andre gruppemedlemmene sitter eksternt og observerer testen. 
            
            Her fikk jeg brynet meg på intervjuferdigheter, og opplevde fort at det var like viktig å notere ned hva som ble sagt, og hva som faktisk ble gjort.
            Med dette fikk vi innsikt i hvilke ideer som hadde gode potensialer til videre utvikling.</p>
            </div>
            <h3 className="font-body text-black mb-5 font-bold text-2xl lg:text-2xl relative flex justify-center subpixel-antialiased">Scrum og videre iterasjoner</h3>
            <div className=" relative flex justify-center mx-auto w-3/4 lg:w-2/4 text-lg">
        <p className="relative flex justify-center font-montserrat mb-5"> </p>
        </div>
